...
var FullCalendar = (function (exports) {
    ...
    return {
      ...
      onKeyDown(ev) {
        if (ev.key === "Enter" || ev.key === " ") {
          handler(ev);
          ev.preventDefault();
          // if space, don't scroll down page
        }
      },
    };
  }
    ...
    render() {
      ...
      return y(
        ...
        Object.assign({}, props /* includes children */, {
          ...
          classNameGenerator: renderProps.isDisabled
            ? undefined
  ...
  function parseViewConfig(input) {
    ...
    if (rawOptions.content) {
      ...
      component = createViewHookComponent(
        Object.assign(Object.assign({}, rawOptions), {
          content: component,
        })
      );
    }
  ...
  */
  ...
  class CalendarDataManager {
    ...
    _handleAction(action) {
      ...
      // BAD. also called in this func in computeIsLoading
      ...
      if (this.hiddenConsumes && touchingEntry) {
        ...
        if (!forceHidden[touchingEntryId]) {
          if (this.allowReslicing) {
            ...
            // replace touchingEntry with our placeholder
  ...
  class TableRow extends DateComponent {
    ...
    queryEventInstanceHeights() {
      ...
      for (let key in segElMap) {
        ...
        // deconstruct how renderFgSegs makes the key
        ...
        chunks: [
          {
            key: "axis",
            content: (
              arg // TODO: make this now-indicator arrow more DRY with TimeColsContent
            ) =>
              y(
                "div",
                {
  ...
  */
  ...
  function buildPositioning(segInputs, strictOrder, maxStackCnt) {
    ...
    // all levelCoords/thickness will have 0.0-1.0
  ...
  class TimeCol extends BaseComponent {
    ...
    renderNowIndicator(segs) {
      ...
      return segs.map((seg, i) =>
        y(
          NowIndicatorContainer, // key doesn't matter. will only ever be one
          {
